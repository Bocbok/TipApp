...
public class MainActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        this.amountTextView = this.findViewById(R.id.amountTextView);
        this.percentTextView = this.findViewById(R.id.percentTextView);
        this.tipTextView = this.findViewById(R.id.tipTextView);
        ...
        EditText amountText = this.findViewById(R.id.amountEditText);
        amountText.addTextChangedListener(amountEditTextWatcher);

        // Asignar el OnSeekBarChangeListeer al percentSeekBar.
        SeekBar percentSeekBar = this.findViewById(R.id.percentSeekBar);
    ...
    private void calculate() {
        ...
        this.tipTextView.setText(currencyFormat.format(tip));
        this.totalTextView.setText(currencyFormat.format(total));
    }
